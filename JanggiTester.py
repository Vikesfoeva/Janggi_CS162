...
class TestJanggi(unittest.TestCase):
    ...
    def test_cannon_no_diagonal(self):
    ...
    def test_chariot_horizontal(self):
    ...
    def test_full_game_1(self):
        ...
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('h8', 'e8'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('i4', 'h4'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('c10', 'd8'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('h3', 'e3'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('a7', 'b7'))
        self.assertFalse(self.game.is_in_check('blue'))
        ...
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('g1', 'i4'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('e7', 'e6'))
        self.assertFalse(self.game.is_in_check('blue'))
        ...
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('g8', 'e7'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('e4', 'e5'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('d7', 'b4'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('e6', 'e4'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('e8', 'e5'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('d3', 'e5'))
        self.assertFalse(self.game.is_in_check('blue'))
        ...
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.is_in_check('blue'))
        self.assertTrue(self.game.make_move('e7', 'g6'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('i4', 'g7'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('g6', 'e5'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('g7', 'i10'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('c7', 'd7'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('c4', 'b4'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('b8', 'b4'))
        self.assertFalse(self.game.is_in_check('blue'))
        ...
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('a1', 'c1'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('g4', 'a4'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('c1', 'c5'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('a4', 'h4'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        ...
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('i10', 'g7'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.is_in_check('blue'))
        self.assertTrue(self.game.make_move('d9', 'd8'))
        self.assertFalse(self.game.is_in_check('blue'))
        ...
        self.assertTrue(self.game.make_move('c5', 'c8'))
        self.assertTrue(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertEqual("RED_WON", self.game.get_game_state())
        self.assertFalse(self.game.make_move("a10", 'a9'))
        self.assertFalse(self.game.make_move('c8', 'c5'))
    ...
    def test_full_game2(self):
        ...
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('h3', 'c3'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('c8', 'c4'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('a4', 'b4'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('a10', 'a1'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('b1', 'e3'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('b8', 'b4'))
        self.assertFalse(self.game.is_in_check('blue'))
        ...
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('c2', 'c3'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('e2', 'f2'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('c4', 'c2'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertTrue(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('f2', 'f3'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('i7', 'h7'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('i4', 'g7'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('i10', 'i1'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('f1', 'e2'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('h7', 'g7'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('g3', 'f1'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('i1', 'i3'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertTrue(self.game.is_in_check('red'))
        ...
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('e3', 'h1'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertFalse(self.game.is_in_check('red'))
        self.assertTrue(self.game.make_move('d3', 'e2'))
        self.assertFalse(self.game.is_in_check('blue'))
        self.assertTrue(self.game.is_in_check('red'))
        self.assertEqual("BLUE_WON", self.game.get_game_state())
        self.assertFalse(self.game.make_move("a10", 'a9'))
        self.assertFalse(self.game.make_move('c8', 'c5'))

    def test_all_the_wrongs(self):
        self.assertFalse(self.game.make_move('a7', 'b6'))
        self.assertFalse(self.game.make_move('a7', 'a8'))
        self.assertFalse(self.game.make_move('a7', 'a5'))
        self.assertFalse(self.game.make_move('a10', 'b9'))
        self.assertFalse(self.game.make_move('a10', 'b10'))
        self.assertFalse(self.game.make_move('c10', 'b8'))
        self.assertFalse(self.game.make_move('d10', 'c9'))
        self.assertFalse(self.game.make_move('b8', 'b2'))
        self.assertFalse(self.game.make_move('b8', 'b3'))
        self.assertFalse(self.game.make_move('e9', 'e2'))
        self.assertFalse(self.game.make_move('b10', 'b2'))
        self.assertFalse(self.game.make_move('b10', 'e7'))
